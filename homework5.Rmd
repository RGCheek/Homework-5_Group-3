...
I AM SO CLOSE!!
I just need to:
1) make the geom_smooth right - it's too smooth right now. Any ideas?
2) Get the plot to print in the right dimensions when we knit
...
homicides %>% 
  ...
  geom_text(data = freddie, label = "Arrest of \n Freddie Gray", 
            color = "white", vjust = -4.5, hjust = 1.1) +
