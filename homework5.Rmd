...
##Block groups 
denver_block <- block_groups(state ="CO", cb=TRUE, class= "sf")

##Change coordinates to sf object
denver_homicides <- st_as_sf(denver, coords= c("lat", "lon")) %>% 
  st_set_crs(4326)

ggplot() + 
  geom_sf(data = denver_block, color = "lightgray") + 
